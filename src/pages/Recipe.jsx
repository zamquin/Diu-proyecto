...
const recetas = [
    ...
    { nombre: 'Ensalada de Papa con Pollo', ingredientes: ['Papa', 'Pollo', 'Cebolla', 'Zanahoria'] , instrucciones: "Cocinar pollo en el horno durante 45 minutos. Cocinar papas en agua hirviendo. Picar cebolla, zanahoria y papas mezclar con las papas."},
];
